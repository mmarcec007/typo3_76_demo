...
return [
    'ctrl' => [
		...
		'searchFields' => 'name,description,price,quantity,image,category',
        'iconfile' => 'EXT:inventory/Resources/Public/Icons/tx_inventory_domain_model_product.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, description, price, quantity, image, category',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, description, price, quantity, image, category, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
	    ...
	    'category' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:inventory/Resources/Private/Language/locallang_db.xlf:tx_inventory_domain_model_product.category',
	        'config' => [
			    'type' => 'inline',
