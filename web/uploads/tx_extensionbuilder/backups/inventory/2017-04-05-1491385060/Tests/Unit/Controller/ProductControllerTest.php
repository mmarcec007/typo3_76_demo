...
{
    /**
     * @var \Twofour\Inventory\Controller\ProductController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Twofour\Inventory\Controller\ProductController::class)
    ...
    public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView()
    {
        ...
        $productRepository = $this->getMockBuilder(\Twofour\Inventory\Domain\Repository\ProductRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $product = new \Twofour\Inventory\Domain\Model\Product();
