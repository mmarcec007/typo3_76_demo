<INCLUDE_TYPOSCRIPT: source="FILE:EXT:simple_blog/Configuration/TypoScript/header.txt">
...
plugin.tx_simpleblog_list.settings.asset {
    styles {
        name = styles
        path = EXT:simple_blog/Resources/Public/Css/styles.css
    }
}
